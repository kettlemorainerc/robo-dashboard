...
import React, {CSSProperties, useState, useRef, useMemo, useCallback, useReducer, MouseEventHandler} from "react"
...
export function FilteredSelect({
    ...
    const filteredOptions = useMemo(() => options.filter(o => o.includes(filter)), [filter]);
        ...
        <div
            ...
            ref={container => {
                if(container && container !== input.current) {
                    console.log({container, input: input.current});
